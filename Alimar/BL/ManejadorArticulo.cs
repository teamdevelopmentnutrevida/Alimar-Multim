...
namespace BL
{
    public class ManejadorArticulo
    {
        public List<articulo> traerLista() {  
            ...
            articulo blusa2 = new articulo("blusa", "RopaAlimar/blusa.jpg", "mujer", 30, "Blusa blaca con tema de verano", 7000, "Blusa de mujer");
            ...
            //pantalones
            articulo pantalon1 = new articulo("pantalon", "RopaAlimar/PantalonNiña.jpg", "mujer", 10, "Pantalón de nña color rosado", 10000, "Pantalón de niña");
            articulo pantalon2 = new articulo("pantalon", "RopaAlimar/PantalonMujer.jpg", "mujer", 30, "Patalón de mujer gris de vestir", 20000, "Pantalón de mujer");
            ...
            articulo pantalon4 = new articulo("pantalon", "RopaAlimar/PantalonHombre.jpeg", "hombre", 30, "Pantalón de hombre gris de vestir", 20000, "Pantalón de hombre");
            ...
            articulo deportiva2 = new articulo("deportiva", "RopaAlimar/deportiva 2.jpg", "mujer", 30, "Outfit de mujer con pantalon largo", 25000, "Outfit deportivo");
            ...
            //pijama
            articulo pijama1 = new articulo("pijama", "RopaAlimar/Pijama1.jpg", "mujer", 30, "Pijama con pantalon", 10000, "Traje de baño de mujer");
            articulo pijama2 = new articulo("pijama", "RopaAlimar/Pijama2.jpg", "mujer", 30, "Pijama con short", 10000, "Traje de baño de mujer");
